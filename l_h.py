...
# times.append([0.56, 1.04, 4.56, 5.04, 5.4, 6.96, 7.52, 7.92, 10.8, 12.04, 14.28])
# keys.append([0.574213, 0.382009, 0.361283, 0.375246, 0.25889, 0.249582, 1.50273, 1.49109, 1.51717, 1.48495, 1.51717])
...
# names.append("RHand")
# times.append([0.56, 1.04, 4.56, 5.04, 5.4, 6.96, 7.52, 7.92, 10.8, 12.04, 14.28])
# keys.append([0.54, 0.3504, 0.33, 0.31, 0.412984, 0.43, 0.69, 0.52, 0.4932, 0.508, 0.4932])

# names.append("RShoulderPitch")
# times.append([1.04, 4.56, 5.4, 6.96, 7.92, 10.8, 12.04, 14.28])
# keys.append([1.54785, 1.57, 1.43506, 1.43292, 1.8071, 1.83624, 1.81476, 1.83624])

# names.append("RShoulderRoll")
# times.append([1.04, 4.56, 5.4, 6.96, 7.52, 7.92, 10.8, 12.04, 14.28])
# keys.append([-0.108956, -0.12, -0.119999, -0.12, -0.640536, -0.533873, -0.536942, -0.526205, -0.536942])
